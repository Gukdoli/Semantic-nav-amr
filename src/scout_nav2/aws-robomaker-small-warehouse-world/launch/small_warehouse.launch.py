...
def generate_launch_description():
    ...
    # Setup to launch the simulator and Gazebo world (with GUI)
    gazebo_sim_with_gui = ExecuteProcess(
        cmd=[
            "ign gazebo",
    ...
    # Setup to launch the simulator and Gazebo world (headless, no GUI)
    ...
    return LaunchDescription([use_sim_time_arg, gui_arg, world_file_arg, gazebo_sim_with_gui, gazebo_sim_headless])
