...
def generate_launch_description():
    ...
    navigation_launcher_py = os.path.join(bringup_launch, "navigation_launch_baseline.py")
    slam_launcher_py = os.path.join(bringup_launch, "slam_launch.py")
    slam_localization_launcher_py = os.path.join(bringup_launch, "slam_localization_launch_baseline.py")
    ...
    params_file_conditional = ReplaceString(
    ...
    configured_params = RewrittenYaml(
        source_file=params_file_conditional,
        root_key=namespace,
        param_rewrites={},
        convert_types=True,
    )
    ...
    bringup_cmds = [
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                "params_file": params_file_conditional,
            }.items(),
        ),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(slam_localization_launcher_py),
            condition=IfCondition(
                PythonExpression(["not ", slam, " and '", localization, "' == 'slam_toolbox'"])
            ),
            launch_arguments={
                "namespace": namespace,
                "map": map_yaml_file,
        ...
        IncludeLaunchDescription(
            ...
            condition=IfCondition(
                PythonExpression(["not ", slam, " and '", localization, "' == 'amcl'"])
            ),
            launch_arguments={
                "namespace": namespace,
                "map": map_yaml_file,
