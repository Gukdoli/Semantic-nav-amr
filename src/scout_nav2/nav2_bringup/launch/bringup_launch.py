...
def generate_launch_description():
    ...
    # Replace the <robot_namespace> placeholder in params file only if use_namespace is True
    # Uses IfCondition so evaluation happens at launch time (not Python parse time)
    ...
    bringup_cmds = [
        Node(
            ...
            executable='component_container',  # Foxy에서 사용 가능한 실행 파일로 변경
            namespace=namespace,
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={'namespace': namespace,
                              ...
                              'params_file': params_file_conditional}.items()
        ),
